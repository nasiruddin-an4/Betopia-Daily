        ...
        {products.map((product) => (
          ...
          >
            ...
            <button 
              ...
              className="mt-4 w-full py-2 border border-red-100 text-red-600 text-[10px] font-bold rounded-lg hover:bg-red-600 hover:text-white transition-all uppercase tracking-widest"
            >
              Add to Cart
            </button>
          </div>
